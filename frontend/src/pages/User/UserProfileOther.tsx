...
function updateList(res: { add: boolean, type: number },
	otherUser: userInfo, frBl: frBl, lstUserGlobal: { id: number; fl: number | null; bl: number | null; User_username: string; User_avatarPath: string | null; }[], setLstUserGlobal: { (value: React.SetStateAction<{ id: number; fl: number | null; bl: number | null; User_username: string; User_avatarPath: string | null; }[]>): void; (value: React.SetStateAction<{ id: number; fl: number | null; bl: number | null; User_username: string; User_avatarPath: string | null; }[]>): void; }) {
...
const FriendBlockUser = (props: { userCtx: { getUserId: () => any; }, id: string, otherUser: userInfo | undefined, jwt: string | null }) => {
...
const LoadAchivement = (props: {jwt: string | null, setErrorCode: (arg0: number) => void, id: string}) => {
...
const LoadResultGame = (props: {setErrorCode: (arg0: number) => void, id: string, otherUser: userInfo | undefined, jwt: string | null}) => {
