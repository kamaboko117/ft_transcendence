...
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", Number)
], Stat.prototype, "rank", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => user_entity_1.User, (user) => user.sstat, { nullable: false, cascade: true, onDelete: 'CASCADE' }),
